...
export default function SignUpPage() {
  ...
  const onSubmit = () => {
    ...
    if (passwordConfirmation.trim().length == 0) {
      ...
      setPasswordConfirmationErrorMessage("Password confirmation is required");
  ...
  return (
    <SafeAreaView className="flex-1 items-center justify-center bg-background-0">
      <Card className="w-[80%] p-8 bg-background-50">
        ...
        <FormControl isInvalid={!passwordConfirmationIsValid}>
          <FormControlLabel>
            <FormControlLabelText className="color-typography-800">
        ...
        <Box className="flex-row gap-1 mt-2">
          <Text className="text-primary-800">Already have an account?</Text>
